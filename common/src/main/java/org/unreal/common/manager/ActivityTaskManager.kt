package org.unreal.common.manager
...
class ActivityTaskManager private constructor() {
    ...
    //结束特定的Activity(s)
    fun finshActivities(vararg activityClasses: Class<out Activity>): ActivityTaskManager {
        activityLinkedList
    ...
    //结束所有的Activities
    fun finshAllActivities(): ActivityTaskManager {
